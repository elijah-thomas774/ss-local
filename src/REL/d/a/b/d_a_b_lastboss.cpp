...
static dCcD_SrcCyl sSrcCyl1 = {
    /* mObjInf */
    {/* mObjAt */ {0, 0, {0, 0, 0}, 0, 0, 0, 0, AT_DIR_NONE, 0},
     /* mObjTg */
...
static dCcD_SrcCyl sSrcCyl2 = {
    /* mObjInf */
    {/* mObjAt */ {0, 0, {0, 0, 0}, 0, 0, 0, 0, AT_DIR_NONE, 0},
     /* mObjTg */ {AT_TYPE_BELLOWS, 0x103, {0, 0x4, 0x407}, 0x0, AT_DIR_NONE},
     /* mObjCo */ {0x0}},
    /* mCylInf */
    {70.f, 30.f}
};
...
static dCcD_SrcCyl sSrcCyl3 = {
    /* mObjInf */
    {/* mObjAt */ {0, 0, {0, 0, 0}, 0, 0, 0, 0, AT_DIR_NONE, 0},
     /* mObjTg */ {0x0, 0x0, {0, 0x0, 0x407}, 0x0, AT_DIR_NONE},
     /* mObjCo */ {0xE5}},
    /* mCylInf */
    {100.f, 250.f}
};
...
static dCcD_SrcSph sSrcSph1 = {
    /* mObjInf */
    {/* mObjAt */ {AT_TYPE_DAMAGE, 0x2008D, {0, 0, 0}, 4, 0, 0, 0, AT_DIR_NONE, 0},
     /* mObjTg */ {0, 0, {0, 0x0, 0x407}, 0, AT_DIR_NONE},
     /* mObjCo */ {0}},
    /* mSphInf */
    {100.0f}
};
...
static dCcD_SrcSph sSrcSph2 = {
    /* mObjInf */
    {/* mObjAt */ {AT_TYPE_DAMAGE, 0x22008D, {0, 0, 4}, 8, 0, 0, 0, AT_DIR_NONE, 0},
     /* mObjTg */ {AT_TYPE_0x800000 | AT_TYPE_BUGNET, 0x103, {0, 0x19, 0x407}, 0, AT_DIR_NONE},
     /* mObjCo */ {0}},
    /* mSphInf */
    {100.0f}
};
...
static dCcD_SrcSph sSrcSph = {
    /* mObjInf */
    {/* mObjAt */ {0, 0, {0, 0, 0}, 0, 0, 0, 0, AT_DIR_NONE, 0},
     /* mObjTg */ {AT_TYPE_BELLOWS, 0x4103, {0, 0x0, 0x40F}, 0, AT_DIR_NONE},
     /* mObjCo */ {0}},
    /* mSphInf */
    {30.0f}
};
...
void dAcBlastboss_c::executeState_Fight() {
    ...
    if (field_0x117C == 0) {
        ...
        mCc1.SetTgAtDir(AT_DIR_ALL);
    } else {
        mCc1.SetTgAtDir(AT_DIR_NONE);
    }
...
void dAcBlastboss_c::executeState_Attack() {
    ...
    if (field_0x113E != 0) {
        ...
        if (mpCurrentAnm == "AttackR") {
            mCc1.SetTgAtDir(AT_DIR_UL | AT_DIR_L | AT_DIR_DL);
        } else if (mpCurrentAnm == "AttackL") {
            mCc1.SetTgAtDir(AT_DIR_UR | AT_DIR_R | AT_DIR_DR);
        } else {
            mCc1.SetTgAtDir(AT_DIR_D);
        }
    }
    checkForCounter();
}
...
void dAcBlastboss_c::executeState_Guard() {
    ...
    static const u32 sGuardFlags[] = {
        AT_DIR_UL | AT_DIR_L | AT_DIR_DL,            // GUARD_RIGHT
        AT_DIR_UL | AT_DIR_L | AT_DIR_DL,            // GUARD_UPRIGHT
        AT_DIR_U | AT_DIR_UL | AT_DIR_L | AT_DIR_DL, // GUARD_DOWNRIGHT
        AT_DIR_DR | AT_DIR_R | AT_DIR_UR,            // GUARD_LEFT
        AT_DIR_DR | AT_DIR_R | AT_DIR_UR,            // GUARD_UPLEFT
        AT_DIR_DR | AT_DIR_R | AT_DIR_UR | AT_DIR_U, // GUARD_DOWNLEFT
        AT_DIR_DR | AT_DIR_DL | AT_DIR_D,            // GUARD_UP
        AT_DIR_UR | AT_DIR_U | AT_DIR_UL,            // GUARD_DOWN
        AT_DIR_STAB,                                 // GUARD_CENTER
        AT_DIR_ALL,
    };
    ...
    if (field_0x113E != 0) {
        ...
        if (link->isAttacking()) {
            switch (dAcPy_c::GetLinkM()->getSpecificAttackDirection()) {
                case AT_DIR_D:  mGuardDirection = GUARD_UP; break;
                case AT_DIR_R:  mGuardDirection = GUARD_LEFT; break;
                case AT_DIR_DR: mGuardDirection = GUARD_UPLEFT; break;
                case AT_DIR_UR: mGuardDirection = GUARD_DOWNLEFT; break;
                case AT_DIR_L:  mGuardDirection = GUARD_RIGHT; break;
                case AT_DIR_DL: mGuardDirection = GUARD_UPRIGHT; break;
                case AT_DIR_UL: mGuardDirection = GUARD_DOWNRIGHT; break;
                case AT_DIR_U:  mGuardDirection = GUARD_DOWN; break;
    ...
    mCc1.SetTgAtDir(sGuardFlags[mGuardDirection]);
    checkForRangeAttack();
}
...
void dAcBlastboss_c::initializeState_GuardBreak() {
    ...
    if (attackDir == AT_DIR_R || attackDir == AT_DIR_DR || attackDir == AT_DIR_UR) {
        side = 0;
    } else if (attackDir == AT_DIR_L || attackDir == AT_DIR_DL || attackDir == AT_DIR_UL) {
        side = 1;
    } else {
        ...
        switch (unk) {
            ...
            default: {
                ...
                if (mStateMgr.isState(StateID_Stun)) {
                    ...
                    field_0x11B8 = 5.0f;
                    field_0x11A4 = 7.0f;
                    if (mLastAttackDirection == AT_DIR_R || mLastAttackDirection == AT_DIR_DR ||
                        mLastAttackDirection == AT_DIR_UR) {
                        field_0x1137 = 1;
                    } else if (mLastAttackDirection == AT_DIR_L || mLastAttackDirection == AT_DIR_DL ||
                               mLastAttackDirection == AT_DIR_UL) {
                        field_0x1137 = 2;
                    } else if (mLastAttackDirection == AT_DIR_STAB) {
                        field_0x1137 = 3;
                    } else {
                        field_0x1137 = 0;
                    }
                ...
                if (mStateMgr.isState(StateID_SitDamage)) {
                    ...
                    if (mLastAttackDirection == AT_DIR_R || mLastAttackDirection == AT_DIR_DR ||
                        ...
                        field_0x1137 = 1;
                               ...
                               mLastAttackDirection == AT_DIR_UL) {
                        field_0x1137 = 2;
                    } else if (mLastAttackDirection == AT_DIR_D) {
                        field_0x1137 = 3;
                    } else {
                        field_0x1137 = 0;
                    }
    ...
    if (mXZDistanceToLink < attackRange) {
        ...
        if (link->checkFlags0x354(0x04)) {
            ...
            if (mStateMgr.isState(StateID_Attack)) {
                if (mpCurrentAnm == "AttackR" &&
                    (attackDir == AT_DIR_R || attackDir == AT_DIR_UR || attackDir == AT_DIR_DR)) {
                    mGuardDirection = GUARD_RIGHT;
                } else if (mpCurrentAnm == "AttackL" &&
                           (attackDir == AT_DIR_L || attackDir == AT_DIR_UL || attackDir == AT_DIR_DL)) {
                    mGuardDirection = GUARD_LEFT;
                } else if (mpCurrentAnm == "AttackU" && attackDir == AT_DIR_D) {
                    mGuardDirection = GUARD_UP;
                } else {
                    return false;
                }
                ...
                switch (attackDir) {
                    case AT_DIR_D:  mGuardDirection = GUARD_UP; break;
                    case AT_DIR_L:  mGuardDirection = GUARD_LEFT; break;
                    case AT_DIR_DL: mGuardDirection = GUARD_UPLEFT; break;
                    case AT_DIR_UL: mGuardDirection = GUARD_DOWNLEFT; break;
                    case AT_DIR_R:  mGuardDirection = GUARD_RIGHT; break;
                    case AT_DIR_DR: mGuardDirection = GUARD_UPRIGHT; break;
                    case AT_DIR_UR: mGuardDirection = GUARD_DOWNRIGHT; break;
                    case AT_DIR_U:  mGuardDirection = GUARD_DOWN; break;
                    default:        mGuardDirection = GUARD_CENTER; break;
                }
...
u8 dAcBlastboss_c::classifyAttackDirection(s32 attackDir) {
    switch (attackDir) {
        case AT_DIR_R:
        case AT_DIR_DR:
        case AT_DIR_UR:   return 0;

        case AT_DIR_L:
        case AT_DIR_DL:
        case AT_DIR_UL:   return 1;

        case AT_DIR_D:    return 2;
        case AT_DIR_U:    return 3;

        case AT_DIR_STAB: return 4;

...
static dCcD_SrcSph sSrcSph = {
    {
     /* mObjAt */ {AT_TYPE_DAMAGE, 0x1D, {0, 0, 0}, 2, 0, 0, 0, AT_DIR_NONE, 0},
     /* mObjTg */
        {~AT_TYPE_COMMON0, 0x200303, {0, 1, 0x40F}, 8, AT_DIR_NONE},
     /* mObjCo*/ {0xE5},
     },
    {35.f}
};
    ...
    switch (s) {
        ...
        default:
            ...
            if (mSph.ChkTgAtHitType(AT_TYPE_SWORD)) {
                ...
                if (mSph.GetTgAtDir() == AT_DIR_D) {
                    x += 0x2000;
                } else if (mSph.GetTgAtDir() == AT_DIR_DR) {
                    a = 0x1000;
                    x += 0x1000;
                } else if (mSph.GetTgAtDir() == AT_DIR_R) {
                    a = 0x2000;
                } else if (mSph.GetTgAtDir() == AT_DIR_UR) {
                    a = 0x1000;
                    x += -0x1000;
                } else if (mSph.GetTgAtDir() == AT_DIR_U) {
                    x += -0x2000;
                } else if (mSph.GetTgAtDir() == AT_DIR_UL) {
                    a = -0x1000;
                    x += -0x1000;
                } else if (mSph.GetTgAtDir() == AT_DIR_L) {
                    a = -0x2000;
                } else if (mSph.GetTgAtDir() == AT_DIR_DL) {
                    a = -0x1000;
                    x += 0x1000;
                } else if (mSph.GetTgAtDir() == AT_DIR_STAB) {
                    x += -0x4000;
                }

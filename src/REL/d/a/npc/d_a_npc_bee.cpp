...
static dCcD_SrcSph beeColliderSrc = {
    /* mObjInf */
    {/* mObjAt */ {AT_TYPE_0x2000000, 0x20000F, {0, 0, 0}, 1, 0, 0, 0, AT_DIR_NONE, 0},
     /* mObjTg */ {AT_TYPE_BUGNET | AT_TYPE_BELLOWS | AT_TYPE_BOMB, 0x00004011, {0, 00, 0x40F}, 8, AT_DIR_NONE},
                   /* mObjCo */ {0}},
    /* mSphInf */
    {15.0f}
};
        ...
        if (bee->mSwordDodgeTimer != 0) {
            ...
            if (mAttackActor == dAcPy_c::GetLink() && dAcPy_c::GetLink()->checkFlags0x354(4) &&
                ...
                if (local_98.squareMagXZ() < 90000.f) {
                    if (dAcPy_c::GetLink()->getSpecificAttackDirection() == (s16)AT_DIR_R ||
                        dAcPy_c::GetLink()->getSpecificAttackDirection() == (s16)AT_DIR_L) {
                        local_98.y += 150.f;

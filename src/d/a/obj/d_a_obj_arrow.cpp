...
cCcD_SrcGObj dAcArrow_c::sCcSrcInf = {
    {AT_TYPE_ARROW, 0x8BB, {0x15,0, 0}, sDamageArrMaybe[0], 0, 0, 0, AT_DIR_NONE, 0}, 
    {
...
const dCcD_SrcSph dAcArrow_c::sCc2 = {
    {{0x0, 0x0, 0x0, 0, 0, 0, 0,  AT_DIR_NONE, 0}, 
    {AT_TYPE_SWORD, 0x211, {0, 0, 0x407}, 0, AT_DIR_NONE}, 
    {0xC28}},
    {100.0f},
};

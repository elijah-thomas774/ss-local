...
static dCcD_SrcSph sSphSrc1 = {
    ...
    {/* mObjAt */ {0, 0, {0, 0, 0}, 0, 0, 0, 0, AT_DIR_NONE, 0},
     /* mObjTg */ {AT_TYPE_BUGNET | AT_TYPE_BELLOWS | AT_TYPE_WIND, 0x200311, {0, 0, 0x40F}, 0, AT_DIR_NONE},
     /* mObjCo */ {0}},
    /* mSphInf */
    {30.f},
};
...
static dCcD_SrcSph sSphSrc2 = {
    /* mObjInf */
    {/* mObjAt */ {0, 0x0, {0, 0, 0}, 0, 0, 0, 0, AT_DIR_NONE, 0},
     /* mObjTg */ {0, 0x0, {0, 0, 0x40F}, 0, AT_DIR_NONE},
     /* mObjCo */ {0x29}},
    /* mSphInf */
    {10.f},
};
